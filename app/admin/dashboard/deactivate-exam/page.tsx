...
export default function DeactivateExamPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-8">
        <h2 className="text-3xl font-bold tracking-tight">Deactivate Exam</h2>
        <p className="text-muted-foreground">Deactivate an existing exam.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Exam Deactivation</CardTitle>
          <CardDescription>
            Deactivating an exam will prevent students from registering for it, but won't affect students who are
            already enrolled.
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
            ...
            {success && (
              <div className="rounded-lg bg-green-50 p-4 text-green-700 dark:bg-green-900/20 dark:text-green-400">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">Exam deactivated successfully!</span>
                </div>
              </div>
            )}
          </CardContent>
          <CardFooter>
            <Button type="submit" className="w-full" disabled={isLoading || !examId}>
              {isLoading ? "Deactivating..." : "Deactivate Exam"}
            </Button>
          </CardFooter>
        </form>
      </Card>
